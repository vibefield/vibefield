...
export function pillClass(v: string | undefined): string {
      ...
      <section className="cards">
        <div className="card">
          ...
          {h ? (
            ...
            <p className="muted">{subError ? String(subError) : "connecting…"}</p>
          )}
        </div>
                ...
                <tr key={u.unit}>
                  ...
                  <td className="muted">
                    ...
                    {u.authUrl ? (
                      <>
                        {" "}
                        <a href={u.authUrl} target="_blank" rel="noreferrer">
                          {u.authUrl}
                        </a>
                      </>
                    ) : null}
