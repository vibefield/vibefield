...
const PIN_EXPECTATIONS = [
  ...
  { file: "Cargo.toml", re: /^ghosttea\s*=\s*"=0\.9\.1"/m, label: 'ghosttea = "=0.9.1"' },
  {
    file: "pnpm-workspace.yaml",
    re: /"@vibecook\/ghosttea-client":\s*0\.9\.1/,
    label: '"@vibecook/ghosttea-client": 0.9.1',
  },
  {
    file: "pnpm-workspace.yaml",
    re: /"@vibecook\/ghosttea-electron":\s*0\.9\.1/,
    label: '"@vibecook/ghosttea-electron": 0.9.1',
  },
  {
    file: "pnpm-workspace.yaml",
    re: /"@vibecook\/ghosttea-react":\s*0\.9\.1/,
    label: '"@vibecook/ghosttea-react": 0.9.1',
  },
  {
    file: "pnpm-workspace.yaml",
    re: /"@vibecook\/ghosttea-protocol":\s*0\.9\.1/,
    label: '"@vibecook/ghosttea-protocol": 0.9.1',
  },
];
