...
authority changes replace behind the common drain. PRC-3d now binds the controller to exact
renderer/window instances and must land before W2 depends on lifecycle behavior.
