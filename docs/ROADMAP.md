...
> stays in the design docs + specs. Last rewritten: **2026-08-17 — PRC-6c1 LANDED.** PRC-5a–d
...
> maxima at zero and rejects a planted real-listener leak. **Now: PRC-6c2 real-worker/two-window/
> restart/log runner and literal 24-hour execution.** The real-tailnet QUIC witness remains
...
| PLUG — plugins | P0–P7 COMPLETE; P8b artifact loading and P8d authoring kit COMPLETE. PRC-0 through PRC-3d landed; **PRC-4/PRC-5 COMPLETE**; **PRC-6a/6b/6c1 LANDED through `bf281bf`**. | `specs/plugin-architecture.md` §8.8/§12.7/§18.5/§21.9/§23/§24.4/§24.6 · `thinking-plugin-runtime-composability.md` · `thinking-prc6-diagnostics-soak.md` | **PRC-6c2 now:** ignored physical runner and literal 24-hour execution. P8c rides WP8; P8e gates third-party listing. |
...
| PLUG — PRC-6 diagnostics + soak | **IN FLIGHT THROUGH PRC-6c1.** 6a `26fcfdf` bounded the shared projection; 6b `06860e0` + `078d8fc` + `9fb74f8` landed passive authenticated aggregation/logging/behavior folds; 6c1 `bf281bf` landed exact censuses and retention inverses. The 120-cycle clean/leak gate is falsifiable and green; full field-app 514/514 and fieldd 580 + 1 skip. | plugin-architecture §23/§24.4/§24.6 · `thinking-prc6-diagnostics-soak.md` | **PRC-6c2:** real worker + simultaneous two windows + restart + physical/log sampling runner, then literal 24h execution. |
...
120-cycle production-seam soak. The real-worker/two-window/restart/log runner and literal 24-hour
claim remain PRC-6c2.
