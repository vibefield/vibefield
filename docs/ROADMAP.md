...
`7e0a0e8`: a shared activation-ownership core and exact structured runtime targets. **PRC-1 is
CODE COMPLETE 2026-08-15** (landing commit pending): the renderer now uses child-bound ownership,
...
- **PLUG → the mind map pack (ECS-native) + the ECS door** — the chosen thread. P8b and
  ...
  builder worktrees. **PRC-D1…D13 are RATIFIED; PRC-0 LANDED `7e0a0e8`; PRC-1 renderer adapter is
  CODE COMPLETE 2026-08-15 (landing commit pending)**; PRC-2's service drain must land before W2
  consumes lifecycle semantics. **Gating now: two
