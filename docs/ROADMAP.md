...
- **PLUG → the mind map pack (ECS-native) + the ECS door** — the chosen thread. P8b and
  ...
  builder worktrees. **PRC-D1…D13 are RATIFIED; PRC-0 LANDED `7e0a0e8`; PRC-1 renderer adapter
  LANDED `4831b0a`**; PRC-2's service drain must land before W2
